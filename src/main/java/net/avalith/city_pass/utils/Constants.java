...
public class Constants {
    public static final Long THEATERPLAY_CAPACITY = 100L;
    public static final String THEATERPLAY_TICKET_SOLD_OUT = "All Tickets are Sold Out";
    ...
    public static final String EXCURSION_NOT_FOUND_MESSAGE = "Excursion not found";
    public static final String EXCURSION_NAME_ALREADY_USED_MESSAGE = "Excursion name is already being used";
