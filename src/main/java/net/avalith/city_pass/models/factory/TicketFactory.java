...
public class TicketFactory implements BaseTicketFactory {
    ...
    @Override
    public Ticket getTicket(TicketRequestDto ticketRequestDto, LocalDateTime purchaseDate) {
        Ticket ticket = null;
        ...
        switch (ticketType) {
            case citypass:
                ...
                ticket = CityPassTicket.createCityPassTicket(ticketType, cityPass, quantity, subTotal, code, purchaseDate);
                break;
            case theaterplay:
                ...
                ticket = TheaterPlayTicket.createTheaterPlayTicket(ticketType, theaterPlay, quantity, subTotal, code, purchaseDate);
                break;
            case excursion:
                ...
                ticket = ExcursionTicket.createExcursionTicket(ticketType, excursion, quantity, subTotal, code, purchaseDate);
                break;
        }
        return ticket;
    }
